...
RSpec.describe 'users/index', type: :system, js: true do
  describe 'users index page' do
    before :each do
      user1 = @user = User.new(name: 'Santiago', photo: 'http://photo.com', bio: 'This is me', posts_counter: 2,
                               email: 'santiagovelosa@gmail.com', password: '123456')
      user1.skip_confirmation!
      user1.save!
      user2 = @user = User.new(name: 'Omar', photo: 'http://photo.com', bio: 'This is me Omar!', posts_counter: 2,
